...
const Header = () => {
  return (
    <header className="fixed top-0 w-full mt-4">
      <nav className="max-w-screen-xl px-16 mx-auto grid grid-flow-col py-4">
        ...
        <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
          ...
          <button className="font-medium tracking-wide py-3 px-8 border border-orange-500 text-orange-500 bg-white-500 outline-none rounded-l-full rounded-r-full">
            {" "}
            Sign Up
          </button>
        </div>
